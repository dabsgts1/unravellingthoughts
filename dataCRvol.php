	...
	$result = $conn->query($sql);
		if($result)
		{
			...
			if($numrows>$countermesg)
			{
				...
				?> <div class="hundred-text"> <?php echo "<a style='text-align:center; font-size: 1.1rem; color:#777; text-decoration:underline;' href='chatroomvol.php?loadmore=$loadmore'>Load More</a>";  ?></div><br/><br/><?php
			}
			else
			{
